...
.. code-block:: bash
    ...
    docker run --name netology85 --privileged=True -v $(pwd)/filebeat-role:/opt/filebeat-role -v $(pwd)/containers.conf:/etc/containers/containers.conf -w /opt/filebeat-role -it netology85-tox bash
